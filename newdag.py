...
with DAG(
    ...
    run_dbt_task = DbtRunOperator(
    task_id='run_dbt_transform',
    dir='/opt/airflow/dags/dbt_models',  # This points to the mounted dbt_models folder
    profiles_dir='/root/.dbt',           # The location of the profiles.yml file
    target='dev',                        # The target in the profiles.yml
)
